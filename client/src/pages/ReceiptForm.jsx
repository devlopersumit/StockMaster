...
const ReceiptForm = () => {
  ...
  const [selectedProduct, setSelectedProduct] = useState({ product_id: '', quantity: 0, unit_price: 0 });
  ...
  const handleAddItem = () => {
    ...
    setSelectedProduct({ product_id: '', quantity: 0, unit_price: 0 });
  };
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">
          {isEdit ? 'Edit Receipt' : 'Create New Receipt'}
        </h1>
